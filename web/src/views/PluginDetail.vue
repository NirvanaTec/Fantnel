<template>
  <div class="plugin-detail">
    <!-- Loading Component -->
    <Loading :visible="isLoading" :text="isLoadingText" :error="isLoadingError" :countdown="countdown" />
    ...
    <Alert :show="showAlert" :title="'插件安装提醒<b><h6>部分 插件 需要重启，才会彻底生效。</h6></b>'" :message="confirmMessage" :show-cancel="true" @ok="handleDownload"
