...
public static class ServerInfoMessage
{
    ...
    {
        return Task.FromResult(PublicProgram.GetServices().Wpf
    ...
    {
        return Task.FromResult(PublicProgram.GetServices().Wpf.QueryNetGameCharacters(InfoManager.GetGameUser().UserId,
